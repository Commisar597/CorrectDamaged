...
public class PlayerMusclesRenderer {
    private final PlayerMusclesModel musclesModel;

    private static final float OFFSET_X = -0.0125F;

    public PlayerMusclesRenderer(EntityModelSet modelSet, boolean isSlim) {
    ...
    public void render(PoseStack poseStack, MultiBufferSource buffer, int packedLight,
                       ...
                       float ageInTicks, float netHeadYaw, float headPitch, PlayerModel<AbstractClientPlayer> parentModel) {
